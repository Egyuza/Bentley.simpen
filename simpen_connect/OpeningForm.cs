...
public partial class OpeningForm : Form
{
    ...
    public OpeningForm()
    {
        ...
        { // сохранённые настройки:
            setMode((Mode)Sets.Opening_mode);
            chbxPolicyThrough.Checked = Sets.Opening_isPolicyThrough;
            chbxRemoveContour.Checked = Sets.Opening_isRequiredRemoveConture;
        }
    ...
    {
        Sets.Opening_mode = (int)getMode();
        Sets.Opening_isPolicyThrough = chbxPolicyThrough.Checked;
        Sets.Opening_isRequiredRemoveConture = chbxRemoveContour.Checked;
        Sets.Save();
    }
